...
- **Mike Bostock**. Copyright holder.  
  D3.js, d3-hexbin, and d3-sankey libraries

- **James Hall**. Copyright holder.  
  jsPDF library

- **yWorks GmbH**. Copyright holder.  
  jsPDF library
...
R package version 1.4.0, <https://mortonanalytics.github.io/myIO/>.

    @Manual{,
      title = {myIO: Interactive Data Visualizations Using 'd3.js'},
      author = {Ryan Morton},
      year = {2026},
